    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 mb-4">
                <h5 class="fw-bold mb-3">Modular Store</h5>
                <p class="text-muted mb-3">Tu tienda online de confianza con los mejores productos y precios.</p>
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="/modular-store" class="text-muted text-decoration-none">Catalog</a></li>
                    <li class="mb-2"><a href="/modular-store/cart" class="text-muted text-decoration-none">Cart</a></li>
                    <li class="mb-2"><a href="#" class="text-muted text-decoration-none">Offers</a></li>
                    <li class="mb-2"><a href="#" class="text-muted text-decoration-none">New Products</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <p class="text-muted mb-3">Suscríbete para recibir ofertas especiales.</p>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <p class="text-muted mb-0">&copy; <?= date('Y') ?> Modular Store. All rights reserved.</p>
            </div>
